...
export default async function decorate(block) {
  ...
  const url = `https://publish-p53543-e1212862.adobeaemcloud.com/graphql/execute.json/securbank/FAQListbyTag;tag=${firsttag};variation=${variationname}?ts=${cachebuster}`;
  const options = {};
